...
class Juego:
    def __init__(self):
        ...
        try:
            ...
            print("Advertencia: No se pudo inicializar el audio. El juego funcionará sin sonido.")
        ...
        try:
            ...
            self.partes_epic = [os.path.join(self.directorio_assets, f"epic_short_part{i}.ogg") for i in range(5)]
